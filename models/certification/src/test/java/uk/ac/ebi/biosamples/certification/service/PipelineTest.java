...
@SpringBootTest(classes = {Pipeline.class, Interrogator.class, FileRecorder.class,
        Curator.class, Certifier.class, ConfigLoader.class, Validator.class, Applicator.class, Identifier.class, NullRecorder.class}, properties = {"job.autorun.enabled=false"})
