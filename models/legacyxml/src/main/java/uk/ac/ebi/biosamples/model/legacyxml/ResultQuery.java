...
@XmlType(
    name = "",
    propOrder = {"summaryInfo", "bioSample", "bioSampleGroup"})
...
public class ResultQuery {
   ...
   *
   * @return possible object is {@link SummaryInfo }
   */
   ...
   *
   * @param value allowed object is {@link SummaryInfo }
   */
   ...
   * </pre>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link BioSample }
   */
   ...
   * </pre>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link BioSampleGroup }
   */
