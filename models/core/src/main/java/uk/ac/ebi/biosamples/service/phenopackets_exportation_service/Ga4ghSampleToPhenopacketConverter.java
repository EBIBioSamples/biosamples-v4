...
import uk.ac.ebi.biosamples.service.ga4ghService.SampleToGa4ghSampleConverter;
...
public class Ga4ghSampleToPhenopacketConverter implements Converter<Ga4ghSample, PhenoPacket> {
    ...
    @Autowired
    public Ga4ghSampleToPhenopacketConverter(BiosamplesRetriever retriever,
    ...
    /**
     * Generates phenopacket json string from accession id of sample
     * @param accession
     * @return phenopacket encoded in json string
     */
    public String getJsonFormattedPhenopacketByAccession(String accession) {
        Sample sample = retriever.getSampleById(accession);
        uk.ac.ebi.biosamples.model.ga4gh_model.Ga4ghSample ga4ghSample = mapper.convert(sample);
    ...
    private Biosample mapBiosample(uk.ac.ebi.biosamples.model.ga4gh_model.Ga4ghSample ga4GhGa4ghSample) {
        ...
        uk.ac.ebi.biosamples.model.ga4gh_model.Age age = ga4GhGa4ghSample.getIndividual_age_at_collection();
