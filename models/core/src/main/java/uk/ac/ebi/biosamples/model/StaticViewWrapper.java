...
public class StaticViewWrapper {
  ...
  public enum StaticView {
    SAMPLES_CURATED(
        StaticViewWrapper.SAMPLE_CURATED_REPO, StaticViewWrapper.SAMPLE_CURATED_REPO_MONGO),
    SAMPLES_DYNAMIC(
        StaticViewWrapper.SAMPLE_PRIMARY_REPO, StaticViewWrapper.SAMPLE_PRIMARY_REPO_MONGO);
