...
public class MongoCertificateToCertificateConverter
    implements Converter<MongoCertificate, Certificate> {
  @Override
  public Certificate convert(MongoCertificate mongoCertificate) {
    return Certificate.build(
        mongoCertificate.getName(), mongoCertificate.getVersion(), mongoCertificate.getFileName());
  }
}
