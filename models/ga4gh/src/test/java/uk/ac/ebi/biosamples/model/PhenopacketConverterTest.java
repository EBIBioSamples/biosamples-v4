...
public class PhenopacketConverterTest {
    PhenopacketConverter phenopacketConverter = new PhenopacketConverter(new PhenopacketConversionHelper());
    ...
    public void testPhenopacketConversion() throws Exception {
        ...
        JsonNode phenopacketExpected = jsonMapper.readValue(new ClassPathResource("phenopacket_1.json").getInputStream(), JsonNode.class);
        Assert.assertEquals(phenopacketExpected.get("biosamples").get(0).get("id").textValue(), phenopacket.getBiosamples(0).getId());
    }
    ...
    private Sample getTestSample() {
        return new Sample.Builder("phenopacket_test")
                ...
                .addAttribute(Attribute.build("organism", "human", "http://purl.obolibrary.org/obo/NCBITaxon_9606", ""))
                .addAttribute(Attribute.build("disease", "colorectal adenocarcinoma", "http://www.ebi.ac.uk/efo/EFO_0000365", ""))
                .addAttribute(Attribute.build("sex", "male", "http://purl.obolibrary.org/obo/PATO_0000384", ""))
                ...
                .addAttribute(Attribute.build("tissue", "liver", "http://purl.obolibrary.org/obo/UBERON_0002107", ""))
                .addAttribute(Attribute.build("lung disease", "yes", "http://purl.obolibrary.org/obo/UBERON_0002107", ""))
                .build();
    }
