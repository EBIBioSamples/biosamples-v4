...
public class AMREntry implements Comparable<AMREntry> {
  ...
  private AMREntry(
      AmrPair antibioticName,
      String resistancePhenotype,
      String measurementSign,
      String measurement,
      String measurementUnits,
      String vendor,
      String laboratoryTypingMethod,
      String platform,
      String laboratoryTypingMethodVersionOrReagent,
      String astStandard,
      String dstMedia,
      String dstMethod,
      String criticalConcentration,
      AmrPair species,
  ...
  public int compareTo(AMREntry other) {
    ...
    int comparison =
        nullSafeStringComparison(this.antibioticName.getValue(), other.antibioticName.getValue());
    ...
    comparison =
        nullSafeStringComparison(this.laboratoryTypingMethod, other.laboratoryTypingMethod);
    ...
    comparison =
        nullSafeStringComparison(
            this.laboratoryTypingMethodVersionOrReagent,
            other.laboratoryTypingMethodVersionOrReagent);
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(getMeasurement(), amrEntry.getMeasurement())
        ...
        && Objects.equals(
            getLaboratoryTypingMethodVersionOrReagent(),
  ...
  public int hashCode() {
    return Objects.hash(
        getAntibioticName().getValue(),
        getResistancePhenotype(),
        getMeasurementSign(),
        getMeasurement(),
        getMeasurementUnits(),
        getVendor(),
        getLaboratoryTypingMethod(),
        getAstStandard(),
        getDstMedia(),
        getDstMethod(),
        getCriticalConcentration(),
        getSpecies(),
        getBreakpointVersion());
  }
  ...
  public static class Builder {
    ...
    @JsonProperty
    public Builder withLaboratoryTypingMethodVersionOrReagent(
        String laboratoryTypingMethodVersionOrReagent) {
      this.laboratoryTypingMethodVersionOrReagent = laboratoryTypingMethodVersionOrReagent;
      return this;
    }
    ...
    public AMREntry build() {
      ...
      //                throw
      // AMREntryBuldingException.createForMissingField("antibioticName");
      //            }
      //
      //            if (this.resistancePhenotype == null ||
      // this.resistancePhenotype.isEmpty()) {
      //                throw AMREntryBuldingException.createForMissingField("resistance
      // phenotype");
      //            }
      //
      //            if (this.measurementValue == null) {
      //                throw AMREntryBuldingException.createForMissingField("measurementValue
      // sign");
      //            }
      //
      ...
      //            }
      //            if (this.laboratoryTypingMethod == null ||
      // this.laboratoryTypingMethod.isEmpty()) {
      //                throw AMREntryBuldingException.createForMissingField("laboratory
      // typing
      // method");
      //            }
      //
      //            if (this.astStandard == null || this.astStandard.isEmpty()) {
      //                throw AMREntryBuldingException.createForMissingField("testing
      // standard");
      //            }
      return new AMREntry(
          this.antibioticName,
          this.resistancePhenotype,
          this.measurementSign,
          this.measurement,
          this.measurementUnits,
          this.vendor,
          this.laboratoryTypingMethod,
          this.platform,
          this.laboratoryTypingMethodVersionOrReagent,
          this.astStandard,
          this.dstMedia,
