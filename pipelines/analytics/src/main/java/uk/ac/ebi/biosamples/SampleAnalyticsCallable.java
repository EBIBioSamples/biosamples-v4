...
public class SampleAnalyticsCallable implements Callable<PipelineResult> {
  private static final Logger LOG = LoggerFactory.getLogger(SampleAnalyticsCallable.class);
  ...
  public SampleAnalyticsCallable(
