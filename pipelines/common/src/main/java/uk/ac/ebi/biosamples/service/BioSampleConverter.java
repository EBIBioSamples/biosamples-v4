...
import static uk.ac.ebi.biosamples.service.EnaSampleToBioSampleConversionConstants.*;
...
import uk.ac.ebi.biosamples.core.model.Publication;
...
public class BioSampleConverter {
  ...
  Sample convertEnaSampleXmlToBioSample(
      final Element eraSampleXmlRootElement, final String bioSampleAccession) {
