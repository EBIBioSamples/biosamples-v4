...
public class ImportXmlRunner implements ApplicationRunner {
  ...
  public void run(ApplicationArguments args) throws Exception {
    ...
    try (InputStream is =
        new GZIPInputStream(new BufferedInputStream(Files.newInputStream(inputXmlPath)))) {

      Map<Element, Future<Resource<Sample>>> futures = new LinkedHashMap<>();

      ElementCallback callback =
          new ImportElementCallback(
              futures, client, xmlSampleToSampleConverter, xmlGroupToSampleConverter);
  ...
  public static class ImportElementCallback implements ElementCallback {
    ...
    public ImportElementCallback(
        Map<Element, Future<Resource<Sample>>> futures,
        BioSamplesClient client,
        XmlSampleToSampleConverter xmlSampleToSampleConverter,
        XmlGroupToSampleConverter xmlGroupToSampleConverter) {
