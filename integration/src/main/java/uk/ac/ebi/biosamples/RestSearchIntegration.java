...
public class RestSearchIntegration extends AbstractIntegration {;
	...
	protected void phaseOne() {
		...
		test5 = Sample.build(test5.getName(), test5.getAccession(), test5.getDomain(), test5.getRelease(), test5.getUpdate(),
				test5.getCharacteristics(), test5AllRelationships, test5.getExternalReferences(), null, null);
	...
	private Sample getSampleTest2() {
		...
		return Sample.build(name, accession, "self.BiosampleIntegrationTest", release, update, attributes, relationships, new TreeSet<>(), null, null);
	}
