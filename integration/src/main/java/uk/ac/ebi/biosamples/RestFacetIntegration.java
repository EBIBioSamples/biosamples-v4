...
public class RestFacetIntegration extends AbstractIntegration {
	...
	private Sample getSampleTest1() {
		...
		return Sample.build(name, accession, domain, release, update, attributes, null, null, null);
	}
	...
	private Sample getEnaSampleTest() {
		...
		return Sample.build(name, accession, domain, release, update, null, null, externalReferences, null);
