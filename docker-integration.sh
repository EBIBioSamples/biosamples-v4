...
java -jar integration/target/integration-4.0.0-SNAPSHOT.jar --phase=1 --biosamples.client.uri=http://localhost:8081/biosamples/beta --biosamples.submissionuri.sampletab=http://localhost:8082/biosamples/beta
