...
* EBI Survey banner
* Website main navigation menu: Bring "Upload" menu under "Submit" menu

[[v5.3.11]]
== v5.3.11 Release notes
* Fixed ASCII docs
* Fix to file upload submissions where attributes are no longer transformed to lower case
...
* Deprecation of AAP authentication in BioSamples
* Bug fixes
