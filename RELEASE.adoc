...
2.1 BioSamples JSON will have core attributes like description, title and organism in lower case
2.2 If a user provided attribute of the same name exists and are in upper case, then they will be treated as separate attributes in the BioSamples JSON
...
2.3 If a user-attributes of the same exists and is also in lower case, then it will be an array of elements within an attribute in the BioSamples JSON
