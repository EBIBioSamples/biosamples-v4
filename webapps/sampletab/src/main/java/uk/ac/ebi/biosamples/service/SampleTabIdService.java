...
public class SampleTabIdService {
  ...
  @Autowired private MongoSampleTabRepository mongoSampleTabRepository;
      ...
      try {
        mongoSampleTab =
            MongoSampleTab.build(
                accessionCandidateQueue.take(),
                mongoSampleTab.getDomain(),
                mongoSampleTab.getSampleTab(),
                mongoSampleTab.getAccessions());
