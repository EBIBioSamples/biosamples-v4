...
public class LegacyXmlSampleController {
  ...
  private Filter sampleAccessionFilter =
      FilterBuilder.create().onAccession("SAM(N|D|EA|E)[0-9]+").build();

  public LegacyXmlSampleController(
  ...
  @CrossOrigin
  @GetMapping(
      value = "/samples/{accession:SAM(?:N|D|EA|E)[0-9]+}",
  ...
  public Sample getSample(@PathVariable String accession) throws IOException {
    log.warn(
        "ACCESSING DEPRECATED API at LegacyXmlSampleController /samples/{accession:SAM(?:N|D|EA|E)[0-9]+}");
