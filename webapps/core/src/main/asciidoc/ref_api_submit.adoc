...
| domain | The AAP domain the sample belongs to. | `String` | Required (only while using AAP authentication)
...
| domain |  `String` | Required (only while using AAP authentication)
...
You can either use AAP or ENA WEBIN AUTHENTICATION to generate the auth token.
...
=== Request
include::{snippets}/post-sample-2/http-request.adoc[]

=== Response
include::{snippets}/post-sample-2/http-response.adoc[]
...
=== Request
include::{snippets}/put-sample-2/http-request.adoc[]

=== Response
include::{snippets}/put-sample-2/http-response.adoc[]
...
=== Request
include::{snippets}/post-curation-2/http-request.adoc[]

=== Response
include::{snippets}/post-curation-2/http-response.adoc[]
...
=== Request
include::{snippets}/accession-sample-2/http-request.adoc[]

=== Response
include::{snippets}/accession-sample-2/http-response.adoc[]
