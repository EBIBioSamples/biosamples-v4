...
BioSamples are described by attributes, which are a pair of a tag and a value. Values are expected to be generally lowercase and use American English spellings; abbreviations should be avoided.
