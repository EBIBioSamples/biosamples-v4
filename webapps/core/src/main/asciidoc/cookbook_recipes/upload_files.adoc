...
for the upload. You can later use the View Submissions tab after login to search for your submission using the submission ID received during your file upload. You will receive a JSON format file containing the sample names and the accessions
