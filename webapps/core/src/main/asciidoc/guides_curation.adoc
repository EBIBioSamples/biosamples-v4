...
== How to find the curation history

Users can access the curation records by adding `/curationlinks` to the
sample link. For example,
https://www.ebi.ac.uk/biosamples/samples/SAMN00000/curationlinks[https://www.ebi.ac.uk/biosamples/samples/SAMN00000/curationlinks].
...
`.json?curationdomain=` to the sample link. For example,
https://www.ebi.ac.uk/biosamples/samples/SAMN11893690.json?curationdomain=[https://www.ebi.ac.uk/biosamples/samples/SAMN11893690.json?curationdomain=]
