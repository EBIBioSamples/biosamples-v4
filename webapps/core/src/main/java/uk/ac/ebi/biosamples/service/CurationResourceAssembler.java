...
@Service
public class CurationResourceAssembler implements RepresentationModelAssembler<Curation, EntityModel<Curation>> {
  ...
  public EntityModel<Curation> toModel(Curation curation) {
    ...
    resource.add(
            entityLinks.linkToItemResource(Curation.class, curation.getHash()).withSelfRel());
  ...
  @Override
  public CollectionModel<EntityModel<Curation>> toCollectionModel(Iterable<? extends Curation> entities) {
    return null;
  }
}
