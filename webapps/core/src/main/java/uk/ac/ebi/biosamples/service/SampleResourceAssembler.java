 ...
 */
@Service
public class SampleResourceAssembler implements RepresentationModelAssembler<Sample, EntityModel<Sample>> {
  ...
  private Link getSelfLink(
    ...
    UriComponentsBuilder uriComponentsBuilder =
        WebMvcLinkBuilder.linkTo(controllerClass, accession).toUriComponentsBuilder();
  ...
  private Link getCurationLinkLink(String accession) {
    return WebMvcLinkBuilder.linkTo(
            WebMvcLinkBuilder.methodOn(SampleCurationLinksRestController.class)
                .getCurationLinkJson(accession, null))
        .withRel("curationLink");
  }

  public EntityModel<Sample> toResource(
      Sample sample,
      Optional<Boolean> legacydetails,
      Optional<List<String>> curationDomains,
      Class controllerClass) {
    ...
    sampleResource.add(getCurationDomainLink(sampleResource.getLink(Link.REL_SELF.value()).get()));
  ...
  public EntityModel<Sample> toResource(Sample sample, Class controllerClass) {
