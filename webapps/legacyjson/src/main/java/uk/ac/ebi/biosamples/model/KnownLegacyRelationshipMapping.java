...
import static uk.ac.ebi.biosamples.model.SupportedSamplesRelationships.*;
...
public final class KnownLegacyRelationshipMapping {
    ...
    public Optional<String> getMappedRelationship(String relationship) {
        ...
        SupportedSamplesRelationships rel = SupportedSamplesRelationships.getFromName(relationship);
