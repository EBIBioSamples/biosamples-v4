...
public class GroupsController {
  ...
  public PagedResources<Resource<LegacyGroup>> allGroups(
    ...
    PagedResources<Resource<LegacyGroup>> pagedResources =
        pagedResourcesConverter.toLegacyGroupsPagedResource(groups);
    pagedResources.add(
        linkTo(methodOn(GroupsSearchController.class).searchMethods()).withRel("search"));
  ...
  public ResponseEntity<Resource<LegacyGroup>> sampleByAccession(@PathVariable String accession)
